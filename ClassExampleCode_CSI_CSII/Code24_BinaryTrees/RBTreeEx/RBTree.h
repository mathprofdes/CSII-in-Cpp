 ...
 */
template <class T> void RBTree<T>::destroySubTree(RBTreeNode<T> *nodePtr) {
  if (nodePtr != NIL) {
    if (nodePtr->left != NIL)
 ...
 */
template <class T> void RBTree<T>::insert(T val) {
 ...
 */
template <class T> void RBTree<T>::insertFix(RBTreeNode<T> *z) {
  RBTreeNode<T> *y = NIL;
 ...
 * node.
 */
template <class T> RBTreeNode<T> *RBTree<T>::getMinNode(RBTreeNode<T> *x) {
  if (x == NIL)
    return NIL;
 ...
 */
template <class T> void RBTree<T>::remove(T val) {
 ...
 * node.
 */
template <class T> void RBTree<T>::deleteFix(RBTreeNode<T> *x) {
  RBTreeNode<T> *w = NIL;
 ...
 */
template <class T> bool RBTree<T>::find(const T &item) {
...
template <class T> void RBTree<T>::RightRotation(RBTreeNode<T> *x) {
...
template <class T> void RBTree<T>::LeftRotation(RBTreeNode<T> *x) {
 ...
 */
template <class T> RBTreeNode<T> *RBTree<T>::findNode(const T &item) {
...
// printing algorithm.
//****************************************************************
template <class T> void RBTree<T>::IndentBlock(int num) {
  for (int i = 0; i < num; i++)
    cout << " ";
}
...
template <class T> void RBTree<T>::PrintTree(int Indent, int Level) {
  if (root)
